...
for eventResult in events:
    ...
    for m in markets:
        ...
        marketbooks = client.list_market_book(market_ids=[m.market_id], price_projection=PriceProjection(price_data=PriceData.EX_BEST_OFFERS), order_projection=OrderProjection.EXECUTABLE, match_projection=MatchProjection.ROLLED_UP_BY_AVG_PRICE)
